...
let setGoogleChatRuntime: typeof import("../../../extensions/googlechat/src/runtime.js").setGoogleChatRuntime;
...
describe("runMessageAction threading auto-injection", () => {
  beforeAll(async () => {
    ...
    ({ setGoogleChatRuntime } = await import("../../../extensions/googlechat/src/runtime.js"));
  });
